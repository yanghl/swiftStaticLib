...
extension UILabel {
    /// 一个label中有不同颜色的显示文字
    public func setReplaceText(text:String,replace:String? = nil,value:UIColor = UIColor(hex: 0xe31436)!)  {
        //富文本设置
    ...
    /// 设置label的行间距,NSMutableAttributedString
    public func setLineSpacing(attributedStr:NSMutableAttributedString,lineSpacing:CGFloat) {
        let style = NSMutableParagraphStyle()
        style.lineSpacing = lineSpacing

...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/RZCarPlateNoTextField/RZCarPlateNoTextField/Core/KeyBoard/Resource/RZCarPlateNoResource.bundle"
  install_resource "${PODS_ROOT}/SKPhotoBrowser/SKPhotoBrowser/SKPhotoBrowser.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/YHLCore/YHLCore.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/swiftStaticLib/swiftStaticLib.bundle"
fi
